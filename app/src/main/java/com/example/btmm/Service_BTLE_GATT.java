...
public class Service_BTLE_GATT extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED = "Service_BTLE_GATT.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED = "Service_BTLE_GATT.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "Service_BTLE_GATT.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE = "Service_BTLE_GATT.ACTION_DATA_AVAILABLE";
